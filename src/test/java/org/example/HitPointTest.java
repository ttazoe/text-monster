...
class HitPointTest {
    ...
    public void testConstructor(){
        ...
        assertEquals(case1.currentAmount,5);
        assertEquals(case1.maxAmount,10);
    ...
    public void testDamaged(){
        ...
        assertEquals(new HitPoint(5, 15), hp.damaged(damage5));
        assertEquals(new HitPoint(0, 15), hp.damaged(damage10));
        assertEquals(new HitPoint(0, 15), hp.damaged(damage15));
    }
}